...
describe('Articles', function () {
   ...
   */
  it('has a virtual 23-character snippet field appended with "..."', function () {
   ...
   */
  it('has an instance method to truncate the content', function () {
  ...
  it('content truncation accepts any length', function () {
  ...
  it('does not save the content once truncated', function() {
  ...
  it('class method findByTitle finds one article by its title', function () {
  ...
  describe('has a version field', function() {
    ...
    it('that is originally 0', function() {
    ...
    it('that increments by 1 every time you update the document', function() {
   ...
   */
  it('has a `tags` field with a custom getter', function () {
