...
var {db, Place, Hotel, Restaurant} = require('./models')
...
//     const activityData = {name: "Strand Bookstore", place: {address: "828 Broadway", city: "New York", state: "NY", phone: "123-456-7890", location: [40.733274, -73.990870]}, age_range: "All" }
//
// Activity.create(activityData, { include: [Place] })
//
